...
class cartesian_to_orbital(unittest.TestCase):
    ...
    def test_r_to_orb_defaults(self):
        ...
        for ctr,kwargs in enumerate(cases):
            p = pytools.kepler_particle(**kwargs)
            ...
            self.assertIs(almost_equal_wrap_2pi(results[ctr]['Omega'],pytools.mod2pi(o.Omega),places), True, '{}'.format(kwargs))
            self.assertIs(almost_equal_wrap_2pi(results[ctr]['omega'],pytools.mod2pi(o.omega),places), True, '{}'.format(kwargs))
    ...
    def test_specified_r_to_orb(self):
        ...
        for kwargs in cases:
            ...
            self.assertIs(almost_equal_wrap_2pi(kwargs['Omega'],pytools.mod2pi(o.Omega),places), True, '{}'.format(kwargs))
            self.assertIs(almost_equal_wrap_2pi(kwargs['omega'],pytools.mod2pi(o.omega),places), True, '{}'.format(kwargs))
    ...
    def test_rand_r_to_orb_f(self):    
        ...
        for q in range(self.N_random_tests):
            ...
            p = pytools.kepler_particle(m=0.,primary=self.sun,**kwargs)
            o = pytools.p2orbit(p,self.sun)
            ...
            self.assertIs(almost_equal_wrap_2pi(kwargs['Omega'],pytools.mod2pi(o.Omega),places), True,'{}'.format(kwargs))
            self.assertIs(almost_equal_wrap_2pi(kwargs['omega'],pytools.mod2pi(o.omega),places), True,'{}'.format(kwargs))
            self.assertIs(almost_equal_wrap_2pi(kwargs['anom'],pytools.mod2pi(o.f),places), True,'{}'.format(kwargs))
    ...
    def test_rand_r_to_orb_f(self):    
        ...
        for q in range(self.N_random_tests):
            ...
            self.assertIs(almost_equal_wrap_2pi(kwargs['Omega'],pytools.mod2pi(o.Omega),places), True,'{}'.format(kwargs))
            self.assertIs(almost_equal_wrap_2pi(kwargs['omega'],pytools.mod2pi(o.omega),places), True,'{}'.format(kwargs))
            self.assertIs(almost_equal_wrap_2pi(kwargs['anom'],pytools.mod2pi(o.l-o.Omega-o.omega),places), True,'{}'.format(kwargs))
